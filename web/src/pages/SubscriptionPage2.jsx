...
export default function SubscriptionPage() {
  ...
  const handleCheckout = async (plan) => {
    ...
    try {
      ...
      // In production, redirect to Stripe with the session ID
      alert(`✅ Subscription initiated!\n\nPlan: ${plan}\nCharity: ${charityName}\n\nStripe integration will process payment in production.`)
      navigate('/dashboard')
    } catch (error) {
      ...
      <div className="container">
        ...
        <section className="dashboard-card">
          ...
          <div className="plans-grid">
            <div 
              className={`plan ${selectedPlan === 'monthly' ? 'selected-plan' : ''}`}
            ...
            >
              ...
              <button 
                ...
                disabled={submitting || selectedPlan !== 'monthly'}
              >
            ...
            <div 
              className={`plan featured ${selectedPlan === 'yearly' ? 'selected-plan' : ''}`}
            ...
            >
              ...
              <button 
                ...
                disabled={submitting || selectedPlan !== 'yearly'}
              >
        ...
        <section className="dashboard-card security-notice">
          ...
          <p>Payment processing powered by <strong>Stripe</strong>. Your payment information is encrypted and never stored on our servers.</p>
        </section>
      </div>
    </div>
  )
